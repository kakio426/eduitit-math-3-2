...
- 결과: 최종 합체 점수로 도달 로봇을 보여 줌. 소형 0점, 중형 100점, 대형 200점, 거대 500점, 초거대 1500점, 전설 2000점 기준
...
- `screenshots/08-result-retry.png`: 이전 재도전 결과 보존 캡처
