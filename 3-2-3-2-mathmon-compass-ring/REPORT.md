...
- 활성 매스몬 기준을 `diversity-reward-pack`의 `수정부엉몬`으로 정리하고, 커버/결과 장면을 새로 연결했습니다.
...
- 설명 2: 10문제, 마법진 점수, 점수 변동 가능성, 전국 순위를 분리해서 보여 줍니다.
...
- 활성 팩: `_shared/mathmon/diversity-reward-pack` (`mathmon-drv-05-crystalowl`, 수정부엉몬).
