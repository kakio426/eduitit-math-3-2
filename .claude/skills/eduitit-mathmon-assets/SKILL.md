...
- 활성 스타일은 `mathmon-v2-toy-3d`다.
- `base-pack`과 `zero-factory-pack`은 legacy 보존용이다.
- 새 차시와 리마스터는 활성 V2 팩을 기본으로 쓴다.
...
4. **이미지 생성**: `STYLE_GUIDE.md`의 V2 프롬프트 기준으로 flat chroma-key 원본을 만들고 `raw-chromakey/`에 저장한다.
