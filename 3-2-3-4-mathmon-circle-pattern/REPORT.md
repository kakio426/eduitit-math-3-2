...
- 실행본 SHA-256: `20beaf41f4acbcb12fa721ff15991b2e219f87e945a95b676c4f7aa3332a9d67`
- 생성 시각: `2026-08-04T15:32:35.905Z`
- 등록 화면 크기: `5개`
- 아래에 직접 삽입한 원본 캡처: `99장`
...
- 화면에서 확인되는 수학 관계: 원으로 규칙과 무늬 만들기을 배우는 차시임을 확인합니다.
...
- 학생이 보는 것: 원으로 규칙과 무늬 만들기 문제를 푸는 방법과 게임 흐름을 그림으로 봅니다.
- 판단하거나 누르는 것: 그림 속 순서와 누를 곳을 확인한 뒤 다음 행동 버튼을 누릅니다.
- 화면에서 확인되는 수학 관계: 원으로 규칙과 무늬 만들기에서 무엇을 비교하거나 계산하는지 확인합니다.
...
- 화면에서 확인되는 수학 관계: 원으로 규칙과 무늬 만들기을 이용해 선택지를 판단합니다.
- 다음 상태로 넘어가는 이유: 고른 답에 따라 오답 또는 정답 확인 상태로 이동합니다.

#### 오개념 확인 · p1-pattern-gap-changed · `engine-flow-desktop-05m-p1-pattern-gap-changed.png`

![desktop 오개념 확인 · p1-pattern-gap-changed](screenshots/engine-flow-desktop-05m-p1-pattern-gap-changed.png)

- 학생이 보는 것: 고른 답이 계산판이나 물건에 들어간 모습과 짧은 오답 피드백을 봅니다.
- 판단하거나 누르는 것: 어디가 맞지 않는지 확인하고 같은 문제에서 다른 답을 고릅니다.
- 화면에서 확인되는 수학 관계: 원으로 규칙과 무늬 만들기의 관계와 고른 답이 왜 맞지 않는지 확인합니다.
- 다음 상태로 넘어가는 이유: 같은 문제에서 다시 판단할 수 있는 상태로 돌아갑니다.

#### 오개념 확인 · p1-pattern-off-line · `engine-flow-desktop-05m-p1-pattern-off-line.png`

![desktop 오개념 확인 · p1-pattern-off-line](screenshots/engine-flow-desktop-05m-p1-pattern-off-line.png)
...
#### 오개념 확인 · p1-pattern-size-changed · `engine-flow-desktop-05m-p1-pattern-size-changed.png`

![desktop 오개념 확인 · p1-pattern-size-changed](screenshots/engine-flow-desktop-05m-p1-pattern-size-changed.png)
...
- 화면에서 확인되는 수학 관계: 원으로 규칙과 무늬 만들기의 완성값을 보상 화면 전에 다시 확인합니다.
...
#### 오개념 확인 · p1-pattern-gap-changed · `engine-flow-tablet-landscape-05m-p1-pattern-gap-changed.png`

![tablet-landscape 오개념 확인 · p1-pattern-gap-changed](screenshots/engine-flow-tablet-landscape-05m-p1-pattern-gap-changed.png)
...
#### 오개념 확인 · p1-pattern-off-line · `engine-flow-tablet-landscape-05m-p1-pattern-off-line.png`

![tablet-landscape 오개념 확인 · p1-pattern-off-line](screenshots/engine-flow-tablet-landscape-05m-p1-pattern-off-line.png)
...
#### 오개념 확인 · p1-pattern-size-changed · `engine-flow-tablet-landscape-05m-p1-pattern-size-changed.png`

![tablet-landscape 오개념 확인 · p1-pattern-size-changed](screenshots/engine-flow-tablet-landscape-05m-p1-pattern-size-changed.png)
...
### codex-in-app · 1280×720 · DPR 2 · 20장
...
### user-visibility-994x632 · 994×632 · DPR 1 · 20장
...
### user-reported-missing-left-progress-1082x987-dpr2 · 1082×987 · DPR 2 · 19장
