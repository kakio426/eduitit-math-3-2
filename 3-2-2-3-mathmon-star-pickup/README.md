...
- 첫 화면: 큰 별과 반딧불몬이 밤하늘 장면 안에 함께 포함된 `cover-generated.webp` 위에 `title-logo-generated.webp` 제목 래스터, 한 줄 목표, 생성형 `start-button-generated.webp` 시작 버튼을 얹습니다. 실제 제목은 접근성용 숨김 텍스트로 남깁니다.
