...
- 보상: 닫힌 문 1장 + 사건 6종
- 결과: UI 없는 전망층 장면 + 등급명 이미지 7장 + 정답 수 + 올라갈 힘 + 생성형 다시 버튼
...
추가 화면 QA는 Codex 브라우저와 같은 931×897에서도 진행했습니다. 첫 단계 정답 확인은 `screenshots/engine-flow-codex-browser-05c-play-step1-confirm.png`, 내림 2단계는 `screenshots/engine-flow-codex-browser-05d-play-step2.png`입니다.
