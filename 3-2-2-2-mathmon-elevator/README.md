...
- 오답은 `올라갈 힘`을 무조건 깎는 명령은 아닙니다. 문제를 다시 풀어 맞히면 감점 사건 60%, 힘이 오르는 사건 40%의 별도 랜덤 보상표에서 문이 열립니다. 첫 시도 정답은 감점 사건 14%, 힘이 오르는 사건 86%이며, 정답 수는 최종 도착 층에도 따로 반영됩니다.
