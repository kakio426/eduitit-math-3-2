  ...
  function mount(root) {
    ...
    root.insertAdjacentHTML("afterbegin", `
      <svg class="mathmon-scoreboard-stage" viewBox="0 0 1280 800" preserveAspectRatio="xMidYMid meet" aria-hidden="false">
        ...
        <image class="mathmon-scoreboard-stage-art" href="assets/runtime-vendor/_shared/scoreboard/scoreboard-celebration-bg-generated.webp" x="0" y="0" width="1280" height="800" preserveAspectRatio="xMidYMid slice"></image>
      ...
      <div class="top-row">
        <span class="brand-badge"><img class="mathmon-brand-mark" data-brand-mark="mathmon-cloud-mark-v1" src="assets/runtime-vendor/_shared/brand/mathmon-cloud-mark.webp" width="1075" height="762" alt="" aria-hidden="true">${escapeHtml(brand)}</span>
