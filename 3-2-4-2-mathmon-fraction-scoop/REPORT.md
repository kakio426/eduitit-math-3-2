...
- 실행본 SHA-256: `e4d1b86b2208e33f3f81872855e518c381ac4224c51e6bece7b01414cbcc232d`
- 생성 시각: `2026-08-23T05:24:58.316Z`
- 등록 회귀 이름: `8개`
- 실제 실행 화면 조건: `7개`
- 동일 조건 별칭 통합: `1개`
- 아래에 직접 삽입한 원본 캡처: `279장`
...
- 같은 실행으로 보존한 회귀 이름: `user-reported-result-panel-centering`
- 캡처 범위: `full-flow`
