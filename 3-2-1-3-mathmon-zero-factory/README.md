...
3차시는 기존 기본 매스몬 10종과 겹치지 않도록 새로 만든 `0 공장 매스몬팩` 10종을 사용합니다. 원본 관리는 `_shared/mathmon/zero-factory-pack/`에서 하고, 실행 패키지에는 `assets/mathmon/zero-factory-pack/*.webp`만 복사해 둡니다.
...
- `assets/mathmon/zero-factory-pack/*.webp`: 0 공장 매스몬 카드 이미지 10종
- `_shared/mathmon/zero-factory-pack/`: 0 공장 매스몬팩 원본 관리 위치
