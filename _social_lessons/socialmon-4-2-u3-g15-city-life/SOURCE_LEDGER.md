...
| --- | --- | --- |
| `/Users/yubyeongju/Downloads/4_2_사회_3_지도서.pdf` | `pdfinfo` 확인: 92쪽, 637.795×822.047pt | 69~86쪽 렌더링(`pdftoppm -r 120`, 69~86)과 텍스트 추출(`pdftotext -layout`)을 함께 대조 |
...
| 84 | 273 | 미래 도시와 환경을 생각하는 보충 자료 | 중심 근거로 사용하지 않음 |
| 85~86 | 274~275 / 활동·정리 | 대중교통, 가까운 거리 걷기·자전거, 쓰레기 줄이기·분리배출·나무 심기 등의 생활 속 해결 방법 | q6 |
...
`_social_lessons/series/4-2/drafts/g15-city-life/PLAN.md`, `QUESTION_DRAFT.md`, `SOURCE_LEDGER.md`의 6문제 구성을 실행 원고로 삼되, q1의 자료·선택지 표현과 q4의 기사 자료 설명은 위 PDF crop을 직접 확인해 확정했다. 도시 생활의 편리함만 강조하지 않고 q2·q5에서 좋은 점과 문제점을 함께 분류하고 q4·q6에서 해결 노력을 판단하도록 했다.
