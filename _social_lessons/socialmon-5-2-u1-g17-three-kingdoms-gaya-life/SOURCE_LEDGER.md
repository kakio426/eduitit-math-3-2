...
|---|---|---|---|
| q1 | PDF 63의 수산리 고분 벽화에서 귀족은 크게, 재주꾼과 시종은 작게 그려졌다. | 직접 확인 | `source-suisanri-status-mural-v1.webp`와 `option-status-*.webp` |
| q2 | PDF 63 본문은 귀족·평민·천민의 역할을 구분한다. | 사실 관계 | 텍스트 문항 |
| q3 | PDF 66에 덩이쇠, 철제 갑옷·투구, 여러 모양의 토기가 보인다. | 직접 확인 | `source-gaya-iron-pottery-v1.webp`와 `option-gaya-*.webp` |
