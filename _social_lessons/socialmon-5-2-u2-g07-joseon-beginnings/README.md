...
5학년 2학기 사회 2단원 1~3차시를 바탕으로, 한양 도성과 유교 건축물에 남은 단서를
찾는 6문제 퀴즈다.
...
- 문항 틀: `source-choice` 2, `match` 1, `choice` 2, `sequence` 1
...
`cfa9afd5c46c9b871aafdf771615580946d16e3f5730b4b3ed03f204135777d9`이며, PDF 18·20쪽을
텍스트와 렌더링으로 대조했다. 문항별 사실·추론 구분과 이미지 범위는
[`SOURCE_LEDGER.md`](SOURCE_LEDGER.md)에 기록했다.

## 이미지 자산

- `source-capital-map-v1-source.png/.webp`: PDF 18쪽 도성도 crop. q1 자료.
- `source-confucian-buildings-v1-source.png/.webp`: PDF 20쪽 건축물·유교 덕목 자료 crop. q3 자료.
...
```bash
node scripts/build-social-quiz.mjs socialmon-5-2-u2-g07-joseon-beginnings
node scripts/check-social-quiz.mjs socialmon-5-2-u2-g07-joseon-beginnings
SOCIAL_QUIZ_BASE_URL=http://127.0.0.1:4174 node scripts/qa-social-quiz.mjs socialmon-5-2-u2-g07-joseon-beginnings
```
