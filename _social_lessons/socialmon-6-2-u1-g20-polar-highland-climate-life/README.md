...
6학년 2학기 사회 1단원 11차시를 위한 5~7분 퀴즈다. 학생은 한대 지역의 추위·눈·빙하와 고산 지역의 높이·큰 일교차가 옷과 농사, 목축, 일에 미친 영향을 비교한다.
...
```bash
node scripts/build-social-quiz.mjs _social_lessons/socialmon-6-2-u1-g20-polar-highland-climate-life
```
