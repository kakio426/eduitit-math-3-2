...
| 3 | `classify` | 87 / 102 | 50~51 | 민주주의를 실천할 때 대화하고 경청하며 타협하는 태도 |
| 4 | `source-choice` | 85 / 100 | 47~48 | 어린이가 함께 활동할 공간이 부족해 새 공간을 만들자는 제안서 |
| 5 | `match` | 87 / 102 | 50~51 | 학생 자치회·학교 구성원 회의·주민 자치의 참여 모습 |
| 6 | `situation-choice` | 88 / 103 | 52~53 | 다른 의견을 듣고 학교와 지역의 일에 참여하는 태도 되짚기 |

## 사실 근거 이미지

| 문항 | 실행 자산 | 보존 원본 | 크기 | 화면 출처 |
|---:|---|---|---:|---|
| 1 | `assets/source-resident-posters-v1.webp` | `assets/source-resident-posters-v1-source.png` | 1400×1450 | `자료: 4_2 사회 1 지도서 100쪽` |
| 4 | `assets/source-child-space-proposal-v1.webp` | `assets/source-child-space-proposal-v1-source.png` | 900×270 | `자료: 4_2 사회 1 지도서 100쪽` |
...
- 다른 의견을 끝까지 듣기, 좋은 점 살피기, 학교와 지역의 문제를 함께 바꾸기를 포함했다.
