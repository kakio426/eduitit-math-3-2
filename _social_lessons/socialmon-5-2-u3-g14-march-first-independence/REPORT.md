# 소셜몬 3·1 운동과 독립운동 잇기 — 전달 보고서

profile-v2 / contract-v3 정식 6문제 단일 HTML이다. `cover → tutorial → play → result` 네 화면, 고르기·이어 보기·나누어 보기 조작, `socialmon-trace-reveal-v1` 흔적 보상을 사용했다. 3·1 운동 뒤 임시 정부와 국내외 독립운동의 활동을 자료로 연결하며, 독립운동과 피해를 승패나 희화화로 다루지 않았다.

## 근거와 학생 문구

- `5_2_사회_3_지도서.pdf` SHA-256: `bffc72e13f62212554b35ab0299edd78c48e1957db99acf6bd83cc4ccd3cfa78`
- PDF 28·34쪽(인쇄 279·285쪽)의 대한민국 임시 정부와 3·1 운동 뒤 국내 움직임 자료를 확인했다.
...
| 입력 | SHA-256 |
|---|---|
| `quiz.json` | `d636c23c16a38da14ac6e97a1087f9e0ac4e96f8a4357dd0ed18eb399d32a7d8` |
...
| 차시 실행 자산 | `e68f9f4c5c6fd3b18544e10b5d2104ae02c5b9efccd6865d76f35f7183a0d557` |
...
- `node scripts/build-social-quiz.mjs socialmon-5-2-u3-g14-march-first-independence` — PASS
- `node scripts/check-social-quiz.mjs socialmon-5-2-u3-g14-march-first-independence` — PASS
- `node scripts/check-stage-ratio.mjs` 및 소셜몬 정책·계약·팩·시리즈 검사 — PASS
- **브라우저 QA**: `SOCIAL_QUIZ_BASE_URL=http://127.0.0.1:4174 node scripts/qa-social-quiz.mjs socialmon-5-2-u3-g14-march-first-independence` — PASS
...
- 최신 영수증: [screenshots/qa-report.json](screenshots/qa-report.json), 생성 시각 `2026-08-12T17:54:23.293Z`; 동결된 정책·하네스 지문을 반영했다.

## 개별 final gate

```sh
SOCIALMON_GATE_CHANGED_FILES_JSON='["_social_lessons/socialmon-5-2-u3-g14-march-first-independence/quiz.json"]' node scripts/verify-socialmon-delivery.mjs --lesson=socialmon-5-2-u3-g14-march-first-independence
```
...
| 입력 | SHA-256 |
|---|---|
| quiz.json | `f95f6a144c760ffad84909d436c5175ba23bdb9ed31add1454654df7b574475d` |
| profile.json | `1390e406212f7f5fc01b9e2a1065106fccab593dfe1891cba4a24472e5164b84` |
| 테마팩 | `71805fadb6ebaff218ef2a5946e5e904c1d8a851be03efa22cde1513b25aa1de` |
| 실행 자산 | `e68f9f4c5c6fd3b18544e10b5d2104ae02c5b9efccd6865d76f35f7183a0d557` |
...
| 캡처 PNG 집합 | `7e8c1ef3ac1b53acc27c008a11f0349f03baf57413cd56590400163f5559bdd5` |

- QA 생성 시각: `2026-08-16T08:40:41.129Z`
